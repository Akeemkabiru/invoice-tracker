        ...
        <div>
          ...
          <div>
            <input
              ...
              className="border-b-4 bg-transparent rounded placeholder:text-gray-300 placeholder:font-semibold placeholder:text-lg w-[250px] p-2 mt-3 placeholder:text-center"
            />
          </div>
        </div>
        <div>
